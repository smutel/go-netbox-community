...
func main() {
	writableCustomFieldRequest := *openapiclient.NewWritableCustomFieldRequest([]string{"ObjectTypes_example"}, "Name_example", interface{}(123)) // WritableCustomFieldRequest | 
